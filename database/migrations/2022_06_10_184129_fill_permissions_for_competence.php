...
class FillPermissionsForCompetence extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCompetence constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.competence',
            'admin.competence.index',
            'admin.competence.create',
            'admin.competence.show',
            'admin.competence.edit',
            'admin.competence.delete',
            'admin.competence.bulk-delete',
        ]);
