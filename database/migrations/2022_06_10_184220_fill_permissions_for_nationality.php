...
class FillPermissionsForNationality extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForNationality constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.nationality',
            'admin.nationality.index',
            'admin.nationality.create',
            'admin.nationality.show',
            'admin.nationality.edit',
            'admin.nationality.delete',
            'admin.nationality.bulk-delete',
        ]);
