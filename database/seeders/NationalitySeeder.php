...
class NationalitySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('nationalities')->insert([
            ...
            ['nationality' => 'extranjero', 'flag_image' => 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Flag_of_the_United_States.svg/1200px-Flag_of_the_United_States.svg.png'],
