<div>
    @can('/participantes/registro')
        <div class="d-flex flex-row-reverse">
            <button class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#agregar" aria-current="page">Agregar
                Disciplina</button>
        </div>
    @endcan
    ...
    <div class="table-responsive">
                ...
                <tr class="text-center">
                    ...
                    @role('admin')
                        <td> <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                data-bs-target="#editar{{ $discipline->id }}"
                                wire:click.prevent="$emit('showModalEditDiscipline', {{ $discipline->id }})">Editar</button>
                        </td>
                    @endrole
                </tr>
            @endforeach
        ...
        @endif
        @livewire('modal-edit-discipline')
