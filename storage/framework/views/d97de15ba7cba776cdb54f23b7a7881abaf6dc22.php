                ...
                <div>
                    <div required class="d-flex flex-row-reverse justify-content-center mb-2">
                        ...
                        <a required class="btn btn-primary m-1 d-flex-inline"href="<?php echo e(route('participants.show')); ?>"> Ver
                            Participantes</a>
                        <a required class="btn btn-success m-1 d-flex-inline"href="<?php echo e(route('participants.show')); ?>"> Cargar
                            en Excel</a>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\luis.contrerasv\Documents\bkinterescuelas\resources\views/participants.blade.php ENDPATH**/ ?>